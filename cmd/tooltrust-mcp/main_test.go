...
func TestHandleListRules_ReturnsAllRules(t *testing.T) {
	...
	assert.Len(t, rules, 13, "should return all 13 built-in rules")
	...
	expectedIDs := []string{"AS-001", "AS-002", "AS-003", "AS-004", "AS-005", "AS-006", "AS-007", "AS-008", "AS-009", "AS-010", "AS-011", "AS-013", "AS-014"}
